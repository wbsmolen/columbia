...
// registration (forcing devices to re-attest, which the Example client handles by
...
async function handleIssue(req, res, start, body) {
  ...
  // unmodified Example install on real Apple hardware. FAILS CLOSED: if App Attest
